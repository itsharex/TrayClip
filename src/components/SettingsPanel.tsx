  ...
  return (
    <div className="flex flex-col gap-3 p-3">
      ...
      <Card size="sm" className="border border-border/50 bg-card p-2.5">
        ...
        <div className="flex items-center justify-between py-1.5">
          ...
          <Input
            ...
            onChange={(e) => {
              const clamped = Math.max(50, Math.min(10000, Number(e.target.value) || 50));
      ...
      <Card size="sm" className="border border-border/50 bg-card p-2.5">
        ...
        {(["open_main_window", "open_quick_panel"] as HotkeyActionKey[]).map((actionKey) => (
          <div key={actionKey}>
            <div className="flex items-center justify-between py-1.5">
              <span className="text-[13px] text-foreground/80">{actionKey === "open_main_window" ? t.openMainWindow : t.openQuickPanel}</span>
